...
- `PRINT_CONFIG=1`: Prints the resolved non-secret configuration and exits before connecting to PostgreSQL, reading checkpoints, spawning threads, or modifying files.
